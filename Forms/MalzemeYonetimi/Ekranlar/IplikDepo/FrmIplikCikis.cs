...
namespace Hesap.Forms.MalzemeYonetimi.Ekranlar.IplikDepo
{
    public partial class FrmIplikCikis : XtraForm
    {
        ...
        {
            hesaplaVeYansit.BoyahaneRenkBilgileriYansit(gridView1, "İplik");
        ...
        private void btnIplikDepoStok_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in frm.stokListesi)
            {
                ...
                gridView1.SetRowCellValue(newRowHandle, "ColorId", values[7]);
                gridView1.SetRowCellValue(newRowHandle, "ColorCode", values[8]);
                gridView1.SetRowCellValue(newRowHandle, "ColorName", values[9]);
                gridView1.SetRowCellValue(newRowHandle, "GrossWeight", values[10]);
